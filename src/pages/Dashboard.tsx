...
const injectDashStyles = () => {
  ...
  s.textContent = `
    ...
    @keyframes stat-border-breathe {
      0%, 100% { border-color: rgba(23,118,242,0.15); box-shadow: 0 2px 16px rgba(23,118,242,0.04); }
      50%      { border-color: rgba(23,118,242,0.32); box-shadow: 0 4px 24px rgba(23,118,242,0.10); }
    }
    .create-pos-btn {
      position: relative;
      overflow: hidden;
...
export default function Dashboard() {
  ...
  const statCardSx = (delay: number = 0) => ({
    borderRadius: '20px',
    p: 2.5,
    pt: 3,
    textAlign: 'center',
    ...
    border: '1.5px solid rgba(23,118,242,0.20)',
    boxShadow: '0 2px 16px rgba(23,118,242,0.05)',
    animation: `stat-border-breathe 4s ${delay}s ease-in-out infinite`,
    ...
    '&::before': {
      ...
      width: '20%',
      height: '100%',
      background: 'linear-gradient(90deg, transparent, rgba(23,118,242,0.06), rgba(0,212,168,0.04), transparent)',
      animation: `stat-light-sweep 5s ${2 + delay}s ease-in-out infinite`,
      pointerEvents: 'none',
    },
    '&:hover': {
      transform: 'translateY(-8px) scale(1.04)',
      borderColor: 'rgba(23,118,242,0.50)',
      boxShadow: '0 20px 50px rgba(23,118,242,0.18), 0 0 0 3px rgba(23,118,242,0.06)',
    },
  });
        ...
        <Box sx={{
          ...
          <Grid container spacing={{ xs: 2, md: 3 }} justifyContent="center" sx={{ maxWidth: 1060, mx: 'auto' }}>
            <Grid item xs={12} sm={6} md="auto" sx={{ display: 'flex', justifyContent: 'center' }}>
              <Paper className="stat-card" elevation={0} sx={{ ...statCardSx(0), width: { xs: '100%', sm: 240 } }}>
                <Box sx={{ width: 38, height: 38, borderRadius: '12px', background: 'linear-gradient(135deg, rgba(23,118,242,0.10), rgba(0,212,168,0.08))', display: 'flex', alignItems: 'center', justifyContent: 'center', mx: 'auto', mb: 1, animation: 'stat-icon-bob 3s 0s ease-in-out infinite' }}>
                  <WorkOutlineIcon sx={{ fontSize: '1.1rem', color: '#1776F2' }} />
                </Box>
                ...
                <Typography sx={{ fontFamily: 'Montserrat', fontWeight: 900, fontSize: '1.72rem', lineHeight: 1.1, color: '#1E1E1E', animation: 'stat-count 0.35s both' }}>
                  {positionsCount ?? '—'}
                </Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md="auto" sx={{ display: 'flex', justifyContent: 'center' }}>
              <Paper className="stat-card" elevation={0} sx={{ ...statCardSx(0.5), width: { xs: '100%', sm: 240 } }}>
                <Box sx={{ width: 38, height: 38, borderRadius: '12px', background: 'linear-gradient(135deg, rgba(23,118,242,0.10), rgba(79,70,229,0.08))', display: 'flex', alignItems: 'center', justifyContent: 'center', mx: 'auto', mb: 1, animation: 'stat-icon-bob 3s 0.4s ease-in-out infinite' }}>
                  <ListAltIcon sx={{ fontSize: '1.1rem', color: '#1776F2' }} />
                </Box>
                <Typography sx={{ fontFamily: 'Montserrat', fontWeight: 700, fontSize: '0.7rem', color: 'text.secondary', mb: 0.6, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
            ...
            <Grid item xs={12} sm={6} md="auto" sx={{ display: 'flex', justifyContent: 'center' }}>
              <Paper className="stat-card" elevation={0} sx={{ ...statCardSx(1), width: { xs: '100%', sm: 240 } }}>
                <Box sx={{ width: 38, height: 38, borderRadius: '12px', background: 'linear-gradient(135deg, rgba(0,212,168,0.10), rgba(23,118,242,0.08))', display: 'flex', alignItems: 'center', justifyContent: 'center', mx: 'auto', mb: 1, animation: 'stat-icon-bob 3s 0.8s ease-in-out infinite' }}>
                  <DescriptionIcon sx={{ fontSize: '1.1rem', color: '#00D4A8' }} />
                </Box>
                <Typography sx={{ fontFamily: 'Montserrat', fontWeight: 700, fontSize: '0.7rem', color: 'text.secondary', mb: 0.6, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
            ...
            <Grid item xs={12} sm={6} md="auto" sx={{ display: 'flex', justifyContent: 'center' }}>
              <Paper className="stat-card" elevation={0} sx={{ ...statCardSx(1.5), width: { xs: '100%', sm: 240 } }}>
                <Box sx={{ width: 38, height: 38, borderRadius: '12px', background: 'linear-gradient(135deg, rgba(23,118,242,0.10), rgba(0,212,168,0.08))', display: 'flex', alignItems: 'center', justifyContent: 'center', mx: 'auto', mb: 1, animation: 'stat-icon-bob 3s 1.2s ease-in-out infinite' }}>
                  <InsightsIcon sx={{ fontSize: '1.1rem', color: '#1776F2' }} />
                </Box>
                <Typography sx={{ fontFamily: 'Montserrat', fontWeight: 700, fontSize: '0.7rem', color: 'text.secondary', mb: 0.6, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
